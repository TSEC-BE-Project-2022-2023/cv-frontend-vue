        ...
        if (simulationArea.mouseDown === false) {
            if (this.type === 'horizontal') {
                if (this.node1.absY() !== this.y1) {
                    ...
                    n = new FANode(this.node1.absX(), this.y1, 2, this.scope.root)
                    this.converge(n)
                    updated = true
                } else if (this.node2.absY() !== this.y2) {
                    // if(this.checkConnections()){this.delete();return;}
                    n = new FANode(this.node2.absX(), this.y2, 2, this.scope.root)
                    this.converge(n)
                    updated = true
                }
                ...
                if (this.node1.absX() !== this.x1) {
                    // if(this.checkConnections()){this.delete();return;}
                    n = new FANode(this.x1, this.node1.absY(), 2, this.scope.root)
                    this.converge(n)
                    updated = true
                } else if (this.node2.absX() !== this.x2) {
                    // if(this.checkConnections()){this.delete();return;}
                    n = new FANode(this.x2, this.node2.absY(), 2, this.scope.root)
                    this.converge(n)
                    updated = true
                }
            }
